...
$packages["."] = (function() {
	var $pkg = {}, $init, js, webgl, funcType, main;
	js = $packages["github.com/gopherjs/gopherjs/js"];
	webgl = $packages["github.com/gopherjs/webgl"];
	funcType = $funcType([], [], false);
	main = function() {
		var $ptr, console, document, driver, iteration;
		document = $global.document;
		console = $global.console;
		driver = document.driver;
		iteration = 0;
		driver.connect($externalize((function() {
			var $ptr;
			iteration = iteration + (1) >> 0;
			driver.addEntity(0.5, 0.5, 0.5);
			driver.addEntity(0.5, 0.55, 0.55);
			driver.update();
			console.log($externalize("Hello", $String), iteration);
		}), funcType));
	};
	$init = function() {
		$pkg.$init = function() {};
